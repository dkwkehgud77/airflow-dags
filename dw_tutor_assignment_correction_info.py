...
# 분 시 일 월 요일
dag = DAG(
    'dw_tutor_assignment_correction_info',
    default_args=default_args,
    description='튜터과제첨삭채점  -> MariaDB, Druid 적재',
    schedule_interval='50 18 * * *' #UTC기준, 매일  새벽 3시 50분 
...
command_t1 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/get_hunet_dw_tutor_assignment_correction_info_mssql_to_mariadb.py {{params.DATE}}"
    
# MariaDB -> Json
command_t2 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/get_hunet_dw_tutor_assignment_correction_info_mariadb_to_json.py {{params.DATE}}"
    
    
## Delete datasource
#command_t3 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
#             "/home/hunetdb/anaconda3/envs/dbadmin/script/delete_datasource_tutor_assignment_correction_info.py"

# Change Config
command_t4 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python /home/hunetdb/imply/conf-hunet/druid-batch-config-dw-tutor-assignment-correction-info.py {{params.DATE}}"

# Json -> Druid
command_t5 = "/home/hunetdb/imply/bin/post-index-task --file /home/hunetdb/imply/conf-hunet/druid-batch-config/dw-tutor-assignment-correction-info/dw-tutor-assignment-correction-info.json"
...
t1 = SSHOperator(
    task_id='tutor_assignment_correction_info_mssql_to_mariadb',
    command=command_t1,
