...
dag = DAG(
    ...
    schedule_interval='01 00 * * *' #kst 오전 09시 01분 기준, 스케줄 실행
    # schedule_interval='52 07 * * *'
)


command_t1 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/get_hunet_xapi_keyword_elasticsearch_to_mssql.py"

command_t2 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/get_hunet_xapi_object_elasticsearch_to_mssql.py"

command_t3 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/get_hunet_xapi_keyword_elasticsearch_to_mssql_tag.py"


command_t4 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/get_hunet_xapi_object_elasticsearch_to_mssql_flow.py"
...
t3 = SSHOperator(
    task_id='xapi_search_keyword_tag',
    command=command_t3,
    ssh_hook=sshHook_imply_3113,
    on_failure_callback=result_msg,  # 실패 시 정보전달
    on_success_callback=get_start_info,  # 성공 시 시작시간 정보 저장
...
t4 = SSHOperator(
    task_id='xapi_flow_object_flow',
    command=command_t4,
    ssh_hook=sshHook_imply_3113,
    on_failure_callback=result_msg,  # 실패 시 정보전달
    on_success_callback=get_start_info, #성공 시 시작시간 정보 전달
    dag=dag)
