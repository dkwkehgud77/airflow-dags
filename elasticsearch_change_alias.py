...
command_t1 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/elasticsearch_change_alias_labs.py"

command_t2 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/elasticsearch_change_alias_tb.py" 

command_t3 = "/home/hunetdb/anaconda3/envs/dbadmin/bin/python " \
             "/home/hunetdb/anaconda3/envs/dbadmin/script/elasticsearch_delete_index_m2d2.py"
...
t1 = SSHOperator(
    task_id='elasticsearch_change_alias_labs',
    command=command_t1,
...
t2 = SSHOperator(
    task_id='elasticsearch_change_alias_tb',
    command=command_t2,
    ssh_hook=sshHook_imply_3113,
    on_failure_callback=result_msg,  # 실패 시 정보전달
    on_success_callback=result_msg,  # 성공 시 시작시간 정보 저장
...
t3 = SSHOperator(
    task_id='elasticsearch_delete_index_m2d2',
    command=command_t3,
    ssh_hook=sshHook_imply_3113,
    on_failure_callback=result_msg,  # 실패 시 정보전달
    on_success_callback=result_msg,  # 성공 시 시작시간 정보 저장
